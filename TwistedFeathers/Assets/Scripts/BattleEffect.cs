...
public enum e_type { nothing, damage, status, buff };
...
public class BattleEffect
{
    ...
    public BattleParticipant Target { get => target; set => target = value; }
    public BattleParticipant User { get => user; set => user = value; }
    public string Message { get => specifier; set => specifier = value; }
